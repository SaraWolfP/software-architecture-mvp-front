...
1. **Cadastre um financiamento** — ex.: imóvel de R$ 500.000, entrada de R$ 100.000, 0,89% a.m., 360 meses, SAC. A dica abaixo do campo de taxa compara o valor digitado com a Selic do dia.
...
5. **Mude para 130% do CDI** e veja o veredito virar: existe um ponto de indiferença, e ele depende da taxa.
